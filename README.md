...
In 2023, I learned [Go (Golang)](https://go.dev/), a powerful language for high-performance and concurrent systems. It quickly became one of my main tools for personal backend projects due to its efficiency and simplicity. 

I mainly work with Frameworks like [Gin](https://gin-gonic.com/), [Fiber](https://gofiber.io/), and [Echo](https://echo.labstack.com/), which allow me to build fast, scalable, and well-structured backend services.

I currently work as a freelance full-stack developer. If you're interested in working with me, feel free to contact me via <a href="mailto:try-flop-driven@duck.com">Email</a> or [Discord](https://discord.gg/sFxkPQDnVF).
